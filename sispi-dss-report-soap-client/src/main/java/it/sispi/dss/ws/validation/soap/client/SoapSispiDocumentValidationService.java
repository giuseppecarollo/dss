 ...
 */
package it.sispi.dss.ws.validation.soap.client;
...
public interface SoapSispiDocumentValidationService extends Serializable {
	...
	List<RemoteDocument> getOriginalDocuments(@WebParam(name = "dataToValidateDTO") DataToValidateDTO dataToValidate);
	 ...
	 /**
   * This method returns the detailed HTML rapresentation of the signed file validation in 
   * 
   * @param dataToValidate
   *                       a {@code DataToValidateDTO} which contains the
   *                       signature, the optional original document(s) and the
   *                       optional validation policy
   * @return a {@code String} the detailed HTML rapresentation of the validation of the signed file in 
   */
  @WebResult(name = "HTMLDatailedReport")
  String getHTMLDetailedReport(@WebParam(name = "dataToValidateDTO") DataToValidateDTO dataToValidate);

  /**
   * This method returns the detailed HTML representation of the signed file validation in 
   * 
   * @param dataToValidate
   *                       a {@code DataToValidateDTO} which contains the
   *                       signature, the optional original document(s) and the
   ...
   * @return a {@code String} the detailed HTML rapresentation of the validation of the signed file in 
   */
  @WebResult(name = "HTMLReport")
  String getHTMLReport(@WebParam(name = "dataToValidateDTO") DataToValidateDTO dataToValidate);
